...
class Delete_win(QDialog):
    ...
    def setupUi(self, Dialog):
        ...
        self.layoutWidget_2.setGeometry(QtCore.QRect(10, 30, 91, 161))
        ...
        self.plainTextEdit.setGeometry(QtCore.QRect(10, 210, 401, 131))
        ...
        self.scrollArea_4.setGeometry(QtCore.QRect(110, 120, 301, 31))
        ...
        self.scrollArea_5.setGeometry(QtCore.QRect(110, 160, 301, 31))
    ...
    def save_data_for_storage2(self):
        ...
        if current_item2 is not None:
            ...
            header = ["Склад №", "Товар","Работник","Дата"]
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_3.setText(_translate("Dialog", "Cклад №"))
        ...
        self.pushButton_10.setText(_translate("Dialog", "Списать"))
