...
class Scroll_get(QDialog):
    ...
    def setupUi(self, Dialog):
        ...
        self.listWidget2.itemClicked.connect(self.save_data)
        ...
        self.addProductButton = QtWidgets.QPushButton(Dialog)
        self.addProductButton.setGeometry(QtCore.QRect(10, 280, 91, 32))
        self.addProductButton.setObjectName("addProductButton")
        self.addProductButton.setText("Добавить товар")
        self.addProductButton.clicked.connect(self.show_add_record_dialog)

        self.newProductLineEdit = QtWidgets.QLineEdit(Dialog)
        self.newProductLineEdit.setGeometry(QtCore.QRect(110, 280, 301, 32))
        self.newProductLineEdit.setObjectName("newProductLineEdit")
    ...
    def save_data(self):
        ...
        data = {
            "Товар": name_text,
            "Склад №": name_text2,
            "Дата истечения": self.textEdit_3.toPlainText(),
            "Дата": self.textEdit_6.toPlainText()

        }

        header = ["Товар", "Склад №", "Дата истечения", "Дата"]
        ...
        # word_file = os.path.join(desktop_path, "get_data.docx")
        # doc = Document()
        # for key, value in data.items():
        #     paragraph = doc.add_paragraph()  # Создаем новый параграф
        #     run = paragraph.add_run(f"{key}: {value}")  # Добавляем текст в параграф
        # doc.save(word_file)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "Приемка товара "))
        self.label_3.setText(_translate("Dialog", "Товар"))
        self.label_2.setText(_translate("Dialog", "Склад №"))
        self.label_5.setText(_translate("Dialog", "Дата истечения"))
        # self.label_7.setText(_translate("Dialog", "Накладная"))
