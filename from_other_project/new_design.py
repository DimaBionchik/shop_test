...
class Get_prod(QDialog):
    ...
    def setupUi(self, Dialog):
        ...
        today = date.today()
        self.textEdit_3.setPlainText(str(today))
        self.scrollArea_3.setWidget(self.scrollAreaWidgetContents_3)
        self.plainTextEdit = QtWidgets.QPlainTextEdit(Dialog)
        self.plainTextEdit.setGeometry(QtCore.QRect(10, 200, 401, 101))
        self.plainTextEdit.setObjectName("plainTextEdit")
        self.pushButton_6 = QtWidgets.QPushButton(Dialog)
        self.pushButton_6.setGeometry(QtCore.QRect(420, 70, 191, 32))
        self.pushButton_6.setObjectName("pushButton_6")
        self.pushButton_7 = QtWidgets.QPushButton(Dialog)
        self.pushButton_7.setGeometry(QtCore.QRect(420, 110, 191, 32))
        self.pushButton_7.setObjectName("pushButton_7")
        # self.pushButton_8 = QtWidgets.QPushButton(Dialog)
        # self.pushButton_8.setGeometry(QtCore.QRect(420, 150, 191, 32))
        # self.pushButton_8.setObjectName("pushButton_8")
        # self.pushButton_9 = QtWidgets.QPushButton(Dialog)
        # self.pushButton_9.setGeometry(QtCore.QRect(420, 190, 191, 32))
        # self.pushButton_9.setObjectName("pushButton_9")
        self.pushButton_10 = QtWidgets.QPushButton(Dialog)
        self.pushButton_10.setGeometry(QtCore.QRect(420, 240, 191, 32))
    ...
    def save_data_for_storage(self):
        ...
        if current_item2 is not None:
            ...
            data = {
                ...
                "Дата": self.textEdit_3.toPlainText()
            }
            # print(data)
            self.date_delivery =self.textEdit_3.toPlainText()
            header = ["Товар", "Склад №", "Дата"]
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "Поставка товара"))
        ...
        self.pushButton_6.setText(_translate("Dialog", "Обновить продукт"))
        self.pushButton_7.setText(_translate("Dialog", "Очистить корзину"))
        # self.pushButton_8.setText(_translate("Dialog", "Изменить корзину"))
        # self.pushButton_9.setText(_translate("Dialog", "Удалить товар"))
