...
class InputDataDialog(QDialog):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Введите дату и количество товара")
...
class Get_prod(QDialog):
    ...
    def setupUi(self, Dialog):
        ...
        self.pushButton_5.setGeometry(QtCore.QRect(420, 30, 191, 32))
        ...
        self.listWidget.itemClicked.connect(self.save_data_for_products)
        ...
        self.listWidget2.itemClicked.connect(self.save_data_for_storage)
        ...
        self.listWidget3.itemClicked.connect(self.save_data_for_client)
        self.plainTextEdit = QtWidgets.QPlainTextEdit(Dialog)
        self.plainTextEdit.setGeometry(QtCore.QRect(10, 200, 401, 101))
        self.plainTextEdit.setObjectName("plainTextEdit")
        self.pushButton_7 = QtWidgets.QPushButton(Dialog)
        self.pushButton_7.setGeometry(QtCore.QRect(420, 110, 191, 32))
        self.pushButton_7.setObjectName("pushButton_7")
        self.pushButton_10 = QtWidgets.QPushButton(Dialog)
        self.pushButton_10.setGeometry(QtCore.QRect(420, 160, 191, 32))
        ...
        today = date.today()
        self.textEdit_4.setPlainText(str(today))
        self.scrollArea_4.setWidget(self.scrollAreaWidgetContents_4)
        self.pushButton_11 = QtWidgets.QPushButton(Dialog)
        self.pushButton_11.setGeometry(QtCore.QRect(420, 70, 191, 32))
        self.pushButton_11.setObjectName("pushButton_11")
        self.pushButton_12 = QtWidgets.QPushButton(Dialog)
        self.pushButton_12.setGeometry(QtCore.QRect(420, 200, 191, 32))
        self.pushButton_12.setObjectName("pushButton_12")
        self.pushButton_5.clicked.connect(self.show_add_record_dialog)
        self.pushButton_10.clicked.connect(self.save_data_products)
        self.pushButton_7.clicked.connect(self.delete_bag)
        self.pushButton_11.clicked.connect(self.add_new_client)
    ...
    def add_new_client(self):
        self.loadFieldNamesAndTypes("Клиенты")
        ...
        if result == QDialog.Accepted:
            ...
            print(data)
            self.my_db.inser_into_clietn(data[0],data[1],data[2])
            self.load_data_client()

    def show_add_record_dialog(self):
        self.loadFieldNamesAndTypes("Продукты")
        ...
        if result == QDialog.Accepted:
            data = dialog.get_data()
            self.my_db.insert_user_data(data[0], data[1], data[2], data[3], data[4])
    ...
    def save_data_for_storage(self):
        ...
        current_item2 = self.listWidget2.currentItem()
        if current_item2 is not None:
            self.name_text2 = current_item2.text()


            data = {
                "Товар": self.name_text,
                "Склад №": self.name_text2,
                "Поставщик": self.name_text3,
                "Дата": self.textEdit_4.toPlainText()
            }

            print(self.name_text3)
            self.date_delivery =self.textEdit_4.toPlainText()

            header = ["Товар", "Склад №","Поставщик","Дата"]

            excel_file = os.path.join(desktop_path, "get_data.xlsx")
            wb = Workbook()
            ws = wb.active
            ws.append(header)
    ...
    def save_data_products(self):
        data = self.my_db.select_sclad(self.name_text2)
        print(data)
        print(self.basket)
        ...
        self.show_notification("Успешно поставлено")
    def retranslateUi(self, Dialog):
        _translate = QtCore.QCoreApplication.translate
        Dialog.setWindowTitle(_translate("Dialog", "Dialog"))
        self.pushButton_5.setText(_translate("Dialog", "Новый продукт"))
        self.label.setText(_translate("Dialog", "Списание товара"))
        self.label_3.setText(_translate("Dialog", "Товар"))
        self.label_2.setText(_translate("Dialog", "Склад №"))
