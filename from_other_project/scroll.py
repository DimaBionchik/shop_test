...
class Scroll(QDialog):
    ...
    def save_data(self):
        ...
        data = {
            ...
            "Покупатель":name_text,
            "Продавец": self.textEdit_2.toPlainText(),
            "Товар": self.textEdit_3.toPlainText(),
            "Сумма": self.textEdit_4.toPlainText(),
            "Склад №А": self.textEdit_5.toPlainText(),
            "Дата": self.textEdit_6.toPlainText()
        }

        header = ["Покупатель", "Продавец", "Товар", "Сумма", "Склад №А", "Дата"]

        excel_file = os.path.join(desktop_path, "ddd.xlsx")
        # wb = Workbook()
        # ws = wb.active
        wb = openpyxl.load_workbook(excel_file)
        sheet = wb.active
        sheet['F2'] = name_text
        sheet['F4'] = self.textEdit_2.toPlainText()
        sheet['F6'] = self.textEdit_3.toPlainText()
        sheet['F8'] = self.textEdit_4.toPlainText()
        sheet['F10'] = self.textEdit_5.toPlainText()
        sheet['F12'] = self.textEdit_6.toPlainText()
        wb.save(excel_file)
        ...
        word_file = os.path.join(desktop_path, "sell_data.docx")
        doc = Document()
