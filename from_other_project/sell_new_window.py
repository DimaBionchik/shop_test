...
class Sell_prod(QDialog):
    ...
    def setupUi(self, Dialog):
        ...
        self.pushButton_10.setGeometry(QtCore.QRect(420, 30, 191, 32))
        ...
        self.pushButton_7.setGeometry(QtCore.QRect(420, 70, 191, 32))
        self.pushButton_7.setObjectName("pushButton_11")
    ...
    def show_input_data_dialog(self, name_text):
        ...
        if input_dialog.exec_() == QDialog.Accepted:
            ...
            new_text = current_text + "\n" + f"Товар: {name_text}, Количество: {amount},Цена:{product_price}"
    ...
    def save_data_for_storage(self):
        ...
        if current_item2 is not None:
            ...
            data = {
                ...
                "Покупатель": self.name_text3,
                "Итоговая стоимость":self.final_price,
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_3.setText(_translate("Dialog", "Склад №"))
        self.label_2.setText(_translate("Dialog", "Товар"))
        self.label_6.setText(_translate("Dialog", "Покупатель"))
